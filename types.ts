...
export type View = 'dashboard' | 'catalog' | 'members' | 'archive' | 'ai-assistant' | 'payments' | 'batch' | 'attendance' | 'progress' | 'settings' | 'student-home' | 'my-performance' | 'my-attendance' | 'replacements' | 'chat';
